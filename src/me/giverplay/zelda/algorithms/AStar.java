package me.giverplay.zelda.algorithms;
...
import me.giverplay.zelda.world.BushTile;
import me.giverplay.zelda.world.Tile;
import me.giverplay.zelda.world.WallTile;
import me.giverplay.zelda.world.WaterTile;
	...
	public static List<Node> findPath(World world, Vector2i start, Vector2i end)
	{
		...
		while(openList.size() > 0)
		{
			...
			for(int i = 0; i < 9; i++)
			{
				...
				if(tile instanceof WallTile || tile instanceof BushTile || tile instanceof WaterTile)
					continue;
				...
				if(i == 0)
				{
					...
					if((test instanceof WallTile) || (test2 instanceof WallTile)
							|| (test instanceof BushTile) || (test2 instanceof BushTile)
							|| (test instanceof WaterTile) || (test2 instanceof WaterTile))
						continue;
